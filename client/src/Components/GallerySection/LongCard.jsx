...
const LongCard = () => {
    return (
        <div className='border-2 mt-4 mb-4 inline-block bg-[#0ca2e739] rounded-2xl w-[300px] h-[320px] md:w-[350px] md:h-[450px] '>
            <div className='w-[100%] h-[100%] p-3 flex flex-col gap-2'>
                <div className='border bg-[#a4f518] rounded-2xl md:w-[325px] md:h-[335px]' >
