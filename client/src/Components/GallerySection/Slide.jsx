...
const Slide = ({image,name}) => {
    return ( 
        ...
        <div className='relative border-2 min-w-40 aspect-[0.92] rounded-2xl z-0 overflow-hidden hover:scale-125  transition-[0.5s] shadow-md shadow-[#ffffff64] slider-track'>
