...
export default function FeaturesSection() {
  return (
    <div className={`featureSection flex flex-col lg:gap-24 gap-10 justify-center xl:h-dvh max-[1280px]:py-10 bg-cover bg-no-repeat`} style={{backgroundImage: `url(${window.innerWidth > 1024 ? desktopBg : window.innerWidth > 648 ? tabBg : mobileBg})`}}>
