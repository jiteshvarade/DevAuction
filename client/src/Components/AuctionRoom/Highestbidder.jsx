            ...
            <div className='border-2 border-[#223534] text-[12px] rounded-lg sm:text-[18px] h-[400px] no-scrollbar overflow-auto'>
                <table className='w-full'>
                    <tr className='p-2 text-[#0CA3E7]'>
                        ...
                        <th className='p-2 sticky top-0 bg-[#050618]'>Total Auction Attended</th>
                        <th className='p-2 sticky top-0 bg-[#050618]'>Highest Amount Bidded</th>
                        <th className='p-2 sticky top-0 bg-[#050618]'>Total Amount Bidded</th>
                    </tr>
