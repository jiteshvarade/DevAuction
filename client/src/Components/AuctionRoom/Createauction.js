        ...
        <div className="flex justify-center items-center  relative h-[100vh] w-[100vw] bg-[#050618]">
            ...
            <div className='flex flex-col items-center gap-4 font-semibold  w-[80%] h-[650px] z-10 ' >
                ...
                <div className='text-white w-[100%] flex gap-6 h-[18%]  ' >
                    ...
                    <div className='border w-[49%] h-[100%] rounded-md bg-[#bec0dd0d]' >
                        <div className='flex flex-col gap-2 w-full px-6 py-4  '>
                            ...
                            <input placeholder='Project Title' className='bg-[#062541] rounded-md px-10 py-2 w-full md:w-14rem' />
                        </div>
                    </div>
                </div>
                ...
                <div className='text-white w-[100%] flex gap-6 h-[18%] ' >
                    <div className=' border w-[49%] h-[100%] rounded-md bg-[#bec0dd0d] flex justify-center items-center ' >
                        <div className='flex flex-col gap-2 w-full p-6 '>
                            ...
                            <input className='bg-[#062541] rounded-md px-10 py-2 w-full md:w-14rem' type='datetime-local' />
                        </div>
                    </div>
                    <div className='border w-[49%] h-[100%] rounded-md bg-[#bec0dd0d]' >
                        <div className='flex flex-col gap-2 w-full px-6 py-4 '>
                ...
                <div className='border shadow-white  text-white w-[100%] h-[18%] rounded-md bg-[#bec0dd0d]' >
                    <div className='flex flex-col gap-2 w-full p-6 '>
                        <label>Project Title</label>
                        <textarea placeholder='Project description' className='bg-[#062541] rounded-md px-10 py-2 h-[40px] w-full md:w-14rem' />
                    </div>
                </div>
