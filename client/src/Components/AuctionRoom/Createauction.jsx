...
const Createauction = ({show,setshow}) => {
    ...
    return (
        <div className={"flex justify-center items-center relative md:w-[900px] z-10 rounded-xl shadow-lg bg-[#050618]"}>
            <div className='flex flex-col items-center gap-4 font-semibold md:w-[800px]  w-[300px] py-6 z-20 ' >
                ...
                <div className='border shadow-white  text-white w-[100%] h-[18%] rounded-md bg-[#bec0dd0d]' >
                    <div className='flex flex-col gap-2 w-full p-6 '>
                        ...
                        <input
                            ...
                            placeholder='URL' className='bg-[#062541] rounded-full px-10 py-2 h-[40px] w-full md:w-14rem' />
                    </div>
                </div>
                ...
                <div className='text-white flex flex-wrap gap-6 w-[100%] justify-evenly' >
                    ...
                    <div className=' border w-full rounded-md md:w-[380px] bg-[#bec0dd0d] flex justify-center items-center ' >
                        <div className='flex flex-col w-full gap-2 p-6 ' >
                            ...
                            <Dropdown value={plan} onChange={(e) => setplan(e.target.value)} options={plans} optionLabel="name" itemTemplate={(option) => (
                                <div className="custom-dropdown-item">
                                    {option.name}
                                </div>
                            )}
                                placeholder="Rooms" className="rounded-full custom-dropdown text-white bg-[#062541] px-10 py-3 w-full md:w-14rem" />
                        </div>
                    </div>
                    ...
                    <div className='border w-full rounded-md md:w-[380px] bg-[#bec0dd0d] flex justify-center items-center' >
                        <div className='flex flex-col gap-2 px-6 py-4  '>
                            ...
                            <input
                                ...
                                placeholder='Project Title' className='bg-[#062541] rounded-full px-10 py-2 w-full md:w-14rem' />
                        </div>
                    </div>
                </div>
                    ...
                    <div className=' border w-full rounded-md md:w-[380px] bg-[#bec0dd0d] flex justify-center items-center' >
                        <div className='flex flex-col gap-2 w-full p-6 '>
                            ...
                            <input
                                ...
                                className='bg-[#062541] rounded-full px-10 py-2 w-full md:w-14rem' type='date' />
                        </div>
                    </div>
                ...
                <div className='w-full text-left'>
                    <GradientBtn placeholder="Submit" className="text-white" onClick={clickHandler} />
                </div>
            </div>
