...
function ProfileEdit(e) {
    ...
    const [image, setImage] = useState('https://cdn.pixabay.com/photo/2016/11/22/21/26/asian-girl-1850617_1280.jpg');
    ...
    const [proImg, setProImg] = useState('"https://i.pinimg.com/236x/fe/af/94/feaf944be5749d956396ebc4662ca39e.jpg"')
    return (
        <>
                    ...
                    <div>
                        <div className='flex-wrap-reverse md:flex-nowrap flex items-center w-full gap-3'>
                            ...
                            <div className='mx-auto w-fit md:w-[20%] md:mx-0 mb-4 relative' >
                                <div >
                                    <img src={image} className='max-h-[200px] rounded-lg mx-auto' alt="" />
                            ...
                            <div className="w-full px-4 rounded-xl bg-[#0CA3E7] bg-opacity-[7%] py-2 mb-2">
                                ...
                                <div id='skill' className='py-2 flex flex-wrap gap-2'>
                                    ...
                                    onClick={()=>{
                                        ...
                                        inputText.setAttribute('Class', 'skills w-[120px] px-4 rounded-xl border-none outline-none bg-[#0CA3E7] bg-opacity-[7%] py-1 shadow-[inset_0_0_5px_white]')
