...
export default function ChatPeople({ recentChatUsers, setSelectedUser, showChats, setShowChats }) {
  return (
    <div className={`chatLeft lg:w-1/3 max-h-screen mx-auto px-10 max-[420px]:p-4 md:py-7 flex-col gap-4 w-full flex-1 min-[420px]:min-w-[410px] max-w-full ${showChats ? "max-[1024px]:hidden" : "flex"}`}>
      <div
