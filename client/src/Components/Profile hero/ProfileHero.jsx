...
export default function ProfileHero({Data,showFollow ,setShowFollow , showFollowing , setShowFollowing , showMenu, setShowMenu }) {
          ...
          <div className="right flex flex-col md:gap-4 gap-1">
            ...
            <div className="followersFollwingProjects flex gap-6 max-[340px]:flex-wrap">
              <div className="projects flex gap-1 items-end flex-wrap justify-center">
                <div className="count sm:text-2xl font-bold text-sm">{Data?.userData.Profile.Projects.length}</div>
              ...
              <div className="followers flex gap-1 items-end flex-wrap justify-center">
                <div className="count sm:text-2xl font-bold text-sm">{Data?.userData.Profile.Followers.length}</div>
                <div 
                onClick={()=>{
              ...
              <div className="following flex gap-1 items-end flex-wrap justify-center">
                <div className="count sm:text-2xl font-bold text-sm">{Data?.userData.Profile.Following.length}</div>
                <div
                onClick={()=>{
            ...
            <div className="description text-xs sm:text-base">
              ...
              <p className="md:text-[18px]">{Data?.userData.Profile.Bio}</p>
            </div>
