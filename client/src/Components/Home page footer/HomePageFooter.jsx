        ...
        <div>
          <div className="flex justify-between items-center flex-wrap gap-4 w-full px-10">
            <h4 className="text-2xl text-center font-bold">
              <span className="text-4xl text-[#8ed7f8]">DEV</span>AUCTION
            </h4>
          ...
          <div className="flex justify-between text-xs lg:text-sm items-center px-10 mt-6">
            ...
            <div className="flex justify-between items-center gap-3 ">
              <a
                href="https://youtube.com/channel/UCTbpFySQiGvwgr_eAEINzhw?si=eYGThi3F-jXeaxWn"
                target="_blank"
              >
                <img width={40} src={youtubeIcon} alt="" />
              </a>
              <a href="https://www.facebook.com/jitesh.varade?mibextid=ZbWKwL" target="_blank">
                <img width={30} src={facebookIcon} alt="" />
              </a>
              <a
                href="https://www.instagram.com/devauction?igsh=MWsyZjhpbm1zNjEwdw=="
                target="_blank"
              >
